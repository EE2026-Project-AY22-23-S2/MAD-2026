...
HD_PWD='C:/Users/eugen/OneDrive - National University of Singapore/Y2S2/EE2026/Project/MAD-2026/MouseAudioDisplay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CartMaster.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CartMaster.tcl -notrace
